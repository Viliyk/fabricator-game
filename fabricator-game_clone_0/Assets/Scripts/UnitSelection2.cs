...
public class UnitSelection2 : MonoBehaviour
{
    ...
    private void ConfirmMultiSelection()
    {
        ...
        for (int i = 0; i < corners.Length; ++i)
        {
            ...
            Debug.DrawLine(Camera.main.ScreenToWorldPoint(corners[i]), hitPoint, raycast ? Color.green : Color.yellow, 0.1f);
        ...
        StartCoroutine(SetSelectionColliderMesh(vertices));
    }

    private IEnumerator SetSelectionColliderMesh(Vector3[] verts)
    {
        ...
        selectionCollider.sharedMesh.vertices = verts;
