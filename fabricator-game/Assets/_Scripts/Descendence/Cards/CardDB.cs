...
public class CardDB : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // TIER 1
        cardList.Add(1, Card.MakeObject(gameObject, 1, "Slime Colony", AddAbilities(13, 0, 0), "Admission: Summon a 1/1 Chimera", 1, 3, 80, false, 2, 4, 2, "Chimera", Resources.Load<Sprite>("Card_Images/smorc"), "Green"));
        cardList.Add(2, Card.MakeObject(gameObject, 2, "Malignant Matter", AddAbilities(2, 0, 0), "Taunt. Admission: Deal 2 damage to an enemy Minion", 1, 3, 100, false, 3, 5, 3, "Defect", Resources.Load<Sprite>("Card_Images/malignant_matter"), "Blue"));
        cardList.Add(3, Card.MakeObject(gameObject, 3, "Sentinel Scout", AddAbilities(1, 0, 0), "Barrier. Admission: Give a friendly Sentinel +2/+2", 1, 3, 100, false, 2, 7, 5, "Sentinel", Resources.Load<Sprite>("Card_Images/lancer"), "Red"));
        ...
        cardList.Add(36, Card.MakeObject(gameObject, 36, "Assault Drone", AddAbilities(0, 0, 0), "", 0, 3, 100, false, 2, 5, 3, "", Resources.Load<Sprite>("Card_Images/drone"), "Grey"));
