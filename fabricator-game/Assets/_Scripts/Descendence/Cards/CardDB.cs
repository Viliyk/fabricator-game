...
public class CardDB : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //                              GameObject, int, string, list,                  string, int,  int,   float,      bool,    int,    int,    double,   string, Sprite,                                      string
        //                              gameObject, Id,  Name,   Abilities,             Text,   Tier, Cost,  EnergyCost, Station, Attack, Health, Cooldown, Type,   ThisImage,                                   Color
        ...
        // TIER 1
        cardList.Add(1, Card.MakeObject(gameObject, 1, "Slime Colony", AddAbilities(13, 0, 0), "Admission: Summon a 1/1 Chimera", 1, 3, 80, false, 25, 80, 2, "Chimera", Resources.Load<Sprite>("Card_Images/smorc"), "Green"));
        cardList.Add(2, Card.MakeObject(gameObject, 2, "Malignant Matter", AddAbilities(2, 0, 0), "Taunt. Admission: Deal 2 damage to an enemy Minion", 1, 3, 100, false, 20, 100, 3, "Defect", Resources.Load<Sprite>("Card_Images/malignant_matter"), "Blue"));
        cardList.Add(3, Card.MakeObject(gameObject, 3, "Sentinel Scout", AddAbilities(1, 0, 0), "Barrier. Admission: Give a friendly Sentinel +2/+2", 1, 3, 100, false, 15, 150, 5, "Sentinel", Resources.Load<Sprite>("Card_Images/lancer"), "Red"));
        ...
        // NOT IN SHOP POOL
        cardList.Add(19, Card.MakeObject(gameObject, 19, "Slime", AddAbilities(0, 0, 0), "", 0, 3, 50, false, 1, 1, 2, "Chimera", cardBackground, "Green"));
        cardList.Add(35, Card.MakeObject(gameObject, 35, "Turret", AddAbilities(0, 0, 0), "", 0, 3, 100, false, 1, 10, 1, "Structure", Resources.Load<Sprite>("Card_Images/turret"), "Grey"));
        cardList.Add(36, Card.MakeObject(gameObject, 36, "Assault Drone", AddAbilities(0, 0, 0), "", 0, 3, 100, false, 20, 100, 3, "", Resources.Load<Sprite>("Card_Images/drone"), "Grey"));
        cardList.Add(39, Card.MakeObject(gameObject, 39, "Guard Bot", AddAbilities(2, 0, 0), "Taunt", 0, 3, 100, false, 1, 3, 3, "Sentinel", cardBackground, "Red"));
    }
