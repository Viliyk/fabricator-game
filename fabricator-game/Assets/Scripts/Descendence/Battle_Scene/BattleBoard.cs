...
public class BattleBoard : MonoBehaviour, IDropHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Update()
    {
        ...
        {
            if (draggable.typeOfCard == Draggable.Slot.BATTLEHAND && transform.childCount < battleManager.frontlineSlots && thisCard.energyCost <= battleManager.energy)
            {
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        //if (d != null && t != null)
        //{
        //    if (d.typeOfCard == Draggable.Slot.BATTLEHAND && !t.structure)
        //    {
        //        //droppedCard.transform.localScale = new Vector3(0.73f, 0.73f, 1);
        //        droppedCard.transform.localScale = new Vector3(2f, 2f, 1);
        ...
        //        battleManager.SpawnToFrontline(droppedCard);
